...
class ColorMode(Enum):
    ...
    SEGMENTATION = 1
    # Let instances of the same category have similar colors (from metadata.thing_colors), 
    # & overlay them with high opacity. This provides more attention on the quality of segmentation.
    IMAGE_BW = 2
...
class VisualizeWithPersonBlocked:
    """
    ...
    def __init__(self, img_rgb, metadata=None, scale=1.0, instance_mode=ColorMode.IMAGE):
        ...
        #self.output = np.zeros_like(self.img)#VisImage(self.img, scale=scale)
    ...
    def draw_polygon(self, segment, color, edge_color=None, alpha=0.5):
        ...
        edge_color = (0.827, 0.827, 0.827, 1)
        alpha = 1
